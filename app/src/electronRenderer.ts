...
import { ElectronRouter } from "./router/electronRouter";
...
container.bind(Symbols.Api).to(ElectronApi).inSingletonScope();
...
container.bind(Symbols.Router).to(ElectronRouter).inSingletonScope();
